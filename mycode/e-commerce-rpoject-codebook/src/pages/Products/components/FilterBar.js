                    ...
                    <ul className="text-slate-700 dark:text-slate-100">
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"SORT_BY",payload : {sortBy:"lowtohigh"},})} id="price-sort-1" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.sortBy === "lowtohigh" || false} />
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"SORT_BY",payload : {sortBy:"hightolow"},})} id="price-sort-2" type="radio" value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.sortBy === "hightolow" || false} />
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"RATINGS",payload : {ratings:"4STARSABOVE"},})} id="rating-sort-1" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.ratings === "4STARSABOVE" || false} />
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"RATINGS",payload : {ratings:"3STARSABOVE"},})} id="rating-sort-2" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.ratings === "3STARSABOVE" || false} />
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"RATINGS",payload : {ratings:"2STARSABOVE"},})} id="rating-sort-3" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.ratings === "2STARSABOVE" || false} />
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"RATINGS",payload : {ratings:"1STARSABOVE"},})} id="rating-sort-4" type="radio" value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.ratings === "1STARSABOVE" || false} />
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"BEST_SELLER_ONLY",payload:{bestSellerOnly:!state.bestSellerOnly }})} id="best-seller" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.bestSellerOnly || false} />
                            ...
                            <div className="flex items-center my-1">
                                ...
                                <input onChange={() => dispatch({type:"ONLY_IN_STOCK",payload:{onlyInStock:!state.onlyInStock }})} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" checked={state.onlyInStock || false} />
