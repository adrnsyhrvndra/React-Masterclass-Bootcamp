...
export const Header = () => {
  ...
  return (
    ...
    <header>
      ...
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900 dark:border-b-2 dark:border-gray-800">

        <div className="container flex flex-wrap items-center justify-between mx-auto">

          <Link to="https://flowbite.com/" className="flex items-center">

              { darkMode ? (<><img src={LogoWhite} className="h-6 mr-3 sm:h-14" alt="Flowbite Logo" /></>) : (<><img src={Logo} className="h-6 mr-3 sm:h-14" alt="Flowbite Logo" /></>) }

          </Link>

          <div id="mobile-nav" className="flex md:order-2">

            <button onClick={() => setDarkMode(!darkMode) } type="button" data-toggle-dark="dark" className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white border border-gray-100 rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
